...
c1 <- cor(proteinProperties[pN1,"cai"], log(gfp[pN1, "abundance"]),
    use="pairwise.complete.obs")
c1S <- cor(proteinProperties[pN1,"cai"], log(gfp[pN1, "abundance"]),
    use="pairwise.complete.obs", method="spearman")

pN2 <- intersect(rownames(proteinProperties), rownames(fcabundance))
c2 <- cor(proteinProperties[pN2,"cai"], log(fcabundance[pN2, "YEPD.mean"]),
    use="pairwise.complete.obs")
c2S <- cor(proteinProperties[pN2,"cai"], log(fcabundance[pN2, "YEPD.mean"]),
    use="pairwise.complete.obs", method="spearman")

c3 <- cor(proteinProperties[pN2,"cai"], log(fcabundance[pN2, "SD.mean"]),
    use="pairwise.complete.obs")

c3S <- cor(proteinProperties[pN2,"cai"], log(fcabundance[pN2, "SD.mean"]),
    use="pairwise.complete.obs", method="spearman")
@ 
...
\newpage
\myincfig{fig-plotCor}{\textwidth}{The three plots are used to 
show the Spearman Correlation Coefficient between CAI and 
various protein abundance data.}
