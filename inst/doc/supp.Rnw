...
<<plotCor, echo=False, results=hide, fig=TRUE, include=FALSE, width=10, height=15>>=
...
\myincfig{fig-plotCor}{\textwidth}{Plots of CAI against $\log$ of the three measured 
abundance datasets.} 
...
vbpGK <- intersect(vbp[["Gavin2006BPGraph"]], vbp[["Krogan2006BPGraph"]])
smoothScatter(zScore1[["Gavin2006"]][vbpGK], zScore1[["Krogan2006"]][vbpGK], 
...
zCorP <- cor(zScore1[["Gavin2006"]][vbpGK], zScore1[["Krogan2006"]][vbpGK],
             use = "pairwise.complete.obs", method="pearson")
zCorK <- cor(zScore1[["Gavin2006"]][vbpGK], zScore1[["Krogan2006"]][vbpGK],
             use = "pairwise.complete.obs", method="kendall")
zCorS <- cor(zScore1[["Gavin2006"]][vbpGK], zScore1[["Krogan2006"]][vbpGK],
             use = "pairwise.complete.obs", method="spearman")
